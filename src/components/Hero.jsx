const Hero = () => {
  return (
    <section id="home" className="min-h-screen flex flex-col justify-center px-6 md:px-16 bg-gray-dark">
      <div className="max-w-4xl">
        ...
        <p className="text-lg text-gray-400 mb-10 max-w-2xl">
          I build high-performance mobile apps and websites, and help content creators grow through SEO and monetize with Google AdSense.
        </p>
